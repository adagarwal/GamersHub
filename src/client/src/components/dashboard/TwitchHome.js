...
import userAccessToken from './storage.js';
                    ...
                    <div className="row" style={{ backgroundColor: "#99aab5" }}>
                        ...
                        <div className="row center-align" style={{ height: "83vh", marginBottom: 0 }}>
                            ...
                            <div className="column s10">
                                <h7 style={{ color: "#7289da", backgroundColor: "#23272a" }}><b>WELCOME TO TWITCH</b></h7>
                                <div style={{ marginTop: "15%" }}>
                                    <a href='https://id.twitch.tv/oauth2/authorize?client_id=d2qvua62wbnmd2falukeg1lqdvefpq&response_type=code&redirect_uri=http://localhost:3000/twitchhome&scope=viewing_activity_read+openid&state=abcd&claims={"id_token":{"preferred_username":null}}'>
                                        ABCD
                                    </a>
                                </div>
                            </div>
